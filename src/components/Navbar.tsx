...
const Navbar = () => {
  ...
  const navItems = [
    { href: '/', label: 'Order', icon: ShoppingBasket },
    { href: '/admin/products', label: 'Manage Products', icon: Settings },
  ];
      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link href="/" className="flex items-center space-x-2 group">
            ...
            <h1 className="text-3xl font-headline font-bold text-primary group-hover:text-accent transition-colors duration-300">SmartOrder AI</h1>
          </Link>
